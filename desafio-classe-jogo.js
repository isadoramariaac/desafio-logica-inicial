//Ultilizado para entrada de dados
...
class Heroi {
    ...
    // Laço de repetição para criar herois de forma infinita, até que o usuario digite 'n' após criação e ataque do herói
    do {

        let name = input.question('Informe do heroi: ');
        let idade = input.questionInt('informe a idade do heroi: ');
        let tipo = input.question('informe o tipo heroi [mago, guerreiro, monge ou nija]: ');
